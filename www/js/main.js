  ...
  if (isMobile.matches) {
    ...
    $(window).scroll(function() {
      ...
      if (ratio >= 0 && ratio <= 13) {
        ...
        $(".work_pic").find(".work-prof").eq(ratio).find(".product-description").removeClass('appear-text-work');
        $(".work_pic").find(".work-prof").eq(ratio).find(".product-button").removeClass('product-button-active');
        $(".work_pic").find(".work-prof").eq(ratio).find(".product-name").removeClass("product-hover");
        ...
        $(".work_pic").find(".work-prof").eq(ratio + 1).find(".product-description").addClass('appear-text-work');
        $(".work_pic").find(".work-prof").eq(ratio + 1).find(".product-button").addClass('product-button-active');
        $(".work_pic").find(".work-prof").eq(ratio + 1).find(".product-name").addClass("product-hover");
              $(".work_pic").find(".work-prof").eq(ratio + 1 - 1).find(".product-name").removeClass("product-hover");
        ...
        $(".work_pic").find(".work-prof").eq(ratio + 2).find(".product-description").removeClass('appear-text-work');
        $(".work_pic").find(".work-prof").eq(ratio + 2).find(".product-button").removeClass('product-button-active');
        $(".work_pic").find(".work-prof").eq(ratio + 2).find(".product-name").removeClass("product-hover");
        $(".work_pic").find(".work-prof").eq(ratio + 2 - 1).find(".product-name").removeClass("product-hover");
      }
...
$('.work-prof').hover(function() {
  ...
  $(this).find(".product-name").toggle("product-hover");
